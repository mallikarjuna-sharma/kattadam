        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="inline-flex items-center gap-2.5 rounded-full border border-primary/40 bg-primary/15 px-4 py-2 text-xs font-extrabold text-primary backdrop-blur-md shadow-lg">
              ...
              <span>
                {isTa ? "அரசு அனுமதி பெற்ற தளம் · 100% நம்பகமானது" : "Registered Platform · Verified Business"}
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm md:text-base text-muted-foreground leading-relaxed">
                {isTa
                  ? "நாங்கள் அரசு அங்கீகாரம் பெற்ற மற்றும் நம்பகமான கட்டட தளமாக இயங்குகிறோம். வாடிக்கையாளர்களுக்கு சிறந்த தரமான பொருட்களை நியாயமான விலையில் பெற்றுத் தருகிறோம்."
            ...
            <div className="absolute -top-5 -right-3 md:-right-5 rounded-2xl border border-primary/50 bg-white/95 dark:bg-[#0d1910]/95 p-3.5 md:p-4 backdrop-blur-xl shadow-2xl flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-xs font-black text-foreground">
                  {isTa ? "100% நம்பகமான நிறுவனம்" : "100% Verified Platform"}
                </p>
                <p className="text-[11px] font-semibold text-primary">
                  {isTa ? "அங்கீகரிக்கப்பட்ட சேவை" : "Trusted Construction Network"}
                </p>
              </div>
            </div>
